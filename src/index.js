...
async function requestNotificationsPermissions() {
	...
	if (permission === "granted") {
		...
		console.log(
			"Unable to get permission to notify. fwEKe6DOgEGMWZLIC2dswq:APA91bGeY5DrLwRJ97owXU2NgtIjZ_LvCCFzy6WyOfeCNa98knpeQknUudGVPq2AgTCaz2OhOrgD6VS5D1iPHkGwOhDbf5qgZxPUI0QDTKcS6NeotgY9dFp-QcLVkfynZb7ANmqvTUpZ"
		);
	}
}
